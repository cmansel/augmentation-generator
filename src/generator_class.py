...
class Generator:
    ...
    def __init__(self: GeneratorSelf, data: Data, augmentation_probability: AugmentationProbability, batch_size: BatchSize) -> None:
        self.data = data
    ...
    def next(self: GeneratorSelf) -> Batch:
        ...
        return next_implementation(self.data, self.augmentation_probability, self.batch_size)
